...
public class Patch {
  ...
  public List<ValidationResult> validate(final File toDir, UpdaterUI ui) throws IOException, OperationCancelledException {
    ...
    //    // Add a new action to delete unknown files in strict mode.
    //    DeleteAction action = new DeleteAction(this, )
    //    result.add(new ValidationResult(ValidationResult.Kind.ERROR, each, ValidationResult.Action.VALIDATE, "Unknown file",
