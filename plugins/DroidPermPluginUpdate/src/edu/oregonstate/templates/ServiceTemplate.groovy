...
/**
 * Template for classes that are children / grandchildren etc.. of android.app.Service
 * Contains code blocks used for permission guard insertion
 * Android services do not support permission requests
 */

class ServiceTemplate extends BaseTemplate {

    ServiceTemplate(String permission, String contextClass, String contextMethodSignature,
    ...
    protected String toCallbackMethod() {
        // android.app.Service does not have guaranteed access to a running UI thread
        return """"""
    }
