 ...
 * Android activities support permission checks and requests
 */
...
class ActivityTemplate extends BaseTemplate {
    ...
    protected String toCheckRequestBlock() {
        ...
        if (android.support.v4.app.ActivityCompat.checkSelfPermission(${contextClassName}.this, ${qualifiedPermissionName})
            != android.content.pm.PackageManager.PERMISSION_GRANTED) {
            android.support.v4.app.ActivityCompat.requestPermissions(${contextClassName}.this, new String[] { ${qualifiedPermissionName} }, ${requestCodeName});
        } else {"""
        return block
    }
