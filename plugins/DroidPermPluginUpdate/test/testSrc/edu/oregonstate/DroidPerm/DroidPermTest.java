...
/**
 * System-Wide tests for DroidPerm
 * All tests simulate running DroidPerm on an open file
 */
...
public class DroidPermTest extends LightCodeInsightFixtureTestCase {
    ...
    private static final String DEFAULT_CLASS = "package android.app; public class Default{}";
    ...
    public void testNonVoidReturnTypePrimitive() {
        doTest(ACTIVITY_CLASS, true);
    }

    public void testDefaultTemplateExistingContextField() {
        doTest(DEFAULT_CLASS, false);
    }

    public void testDefaultTemplateExistingContextLocal() {
        doTest(DEFAULT_CLASS, false);
    }

    public void testDefaultTemplateExistingContextParameter() {
        doTest(DEFAULT_CLASS, false);
    }

    public void testAnonymousClassInSelectionTopOfMethod() {
        doTest(ACTIVITY_CLASS, true);
    }
    ...
    public void testAnonymousClassFragment(){
        doTest(FRAGMENT_CLASS, true);
    }

    public void testDefaultTemplateExistingContextsCorrectOrder(){
        doTest(DEFAULT_CLASS, false);
    }

    public void testAnonymousClassExtractLocalVariable() {
        doTest(ACTIVITY_CLASS, true);
    }
    ...
    private void doTest(String Class, boolean insertRequest) {
        ...
        if(Class.equals(ACTIVITY_CLASS) || Class.equals(FRAGMENT_CLASS) || Class.equals(DEFAULT_CLASS)){
