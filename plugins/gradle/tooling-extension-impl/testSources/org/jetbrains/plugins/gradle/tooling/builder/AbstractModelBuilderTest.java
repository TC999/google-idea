...
public abstract class AbstractModelBuilderTest {
  ...
  public static final String GRADLE_v2_0 = "2.0";
  ...
  private static class DistributionLocator {
    ...
    static String getRepoUrl(boolean isSnapshotUrl) {
      return ObjectUtils.chooseNotNull(
        ...
        IS_UNDER_TEAMCITY ? isSnapshotUrl ? INTELLIJ_LABS_GRADLE_SNAPSHOT_MIRROR : INTELLIJ_LABS_GRADLE_RELEASE_MIRROR : null
      );
    }
  }
}
