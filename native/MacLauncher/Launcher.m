...
NSBundle *findMatchingVm() {
    ...
    NSLog(@"values of %@: %@", variable, explicit);
    if (explicit != nil) {
...
NSArray *parseVMOptions() {
    ...
    [options addObjectsFromArray:[VMOptionsReader readFile:getApplicationVMOptionsPath()]];
    [options addObjectsFromArray:[VMOptionsReader readFile:getUserVMOptionsPath()]];
    [options addObjectsFromArray:[VMOptionsReader readFile:getOverrideVMOptionsPath()]];
