...
public class PlatformUsageTrackerTest extends TestCase {
  public void testMessageIgnored() {
    ...
    assertTrue(PlatformUsageTracker.getDescription(ioe).startsWith("IOException @ PlatformUsageTrackerTest.java:37 <-"));
  }
  ...
  public void testRepetitiveFileNames() {
    ...
    assertEquals("IndexNotReadyException @ FileBasedIndexImpl.java:853 <- :802 <- :786 <- StubIndexImpl.java:250 <- :238 <- StubIndex.java:76 <- :95 <- StubIndexImpl.ja",
  ...
  public void testJavaLangSkipped() {
    ...
    assertEquals("StringIndexOutOfBoundsException @ . <- AdbService.java:83", PlatformUsageTracker.getDescription(t));
  }
