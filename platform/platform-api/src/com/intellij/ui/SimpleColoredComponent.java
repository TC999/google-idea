...
public class SimpleColoredComponent extends JComponent implements Accessible, ColoredTextContainer {
  ...
  @NotNull private final List<String>                     myFragments      = new ArrayList<String>(3);
  @NotNull private final List<SimpleTextAttributes>       myAttributes     = new ArrayList<SimpleTextAttributes>(3);
  ...
  /**
   * Holds value of the last width limit used for {@link #computeTextDimension(java.awt.Font, boolean, int) calculating text dimensions}.
   * <p/>
  ...
  @NotNull
  public SimpleColoredComponent appendLineBreak() {
    WrapsAwareTextHelper.appendLineBreak(myFragments);
