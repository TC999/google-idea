...
public class Main {
  ...
  private static final String MAIN_LOG_PROPERTY = "com.intellij.idea.Main.LOG";
  ...
  private static void installPatch() throws IOException {
    ...
    appendLog("[Patch] Original patch %s: %s\n", originalPatchFile.exists() ? "exists" : "does not exists",
  ...
  public static void showMessage(String title, Throwable t) {
    ...
    String p = System.getProperty("com.intellij.idea.Main.LOG");
    if (p != null) {
      message.append("\n").append(p);
    }
  ...
  public static void dumpDelayedLogging() {
    ...
    if (p != null) {
      ...
      String sp = PathManager.getSystemPath();
      File log = new File(sp, "log");
