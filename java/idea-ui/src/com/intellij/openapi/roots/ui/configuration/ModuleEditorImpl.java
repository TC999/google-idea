...
public abstract class ModuleEditorImpl implements ModuleEditor {
  ...
  public ModuleEditorImpl(Project project, ModulesProvider modulesProvider, @NotNull Module module) {
    myProject = project;
